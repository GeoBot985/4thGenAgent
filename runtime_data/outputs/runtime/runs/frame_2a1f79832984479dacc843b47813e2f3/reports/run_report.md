...
| Field | Value |
|---|---|
| Frame ID | frame_2a1f79832984479dacc843b47813e2f3 |
...
- Event ID: evt_97b0be02d18447dd9041994b5f141cd2
- Event Type: manual.procurement_low_stock_reorder
- Source: operator_scenario_pack

```json
{
  "event_id": "evt_97b0be02d18447dd9041994b5f141cd2",
...
```json
{
  ...
  "po_id": "PO-DRAFT-20260504-202834-C93A09",
  "status": "draft",
...
```json
{
  "body": "Good day Cape Tech Supplies, please find draft purchase order PO-DRAFT-20260504-202834-C93A09 for SKU-1002. Please confirm availability and lead time.",
  "included_po_id": true,
  "included_sku_lines": true,
  "included_supplier_name": true,
  "invented_terms": false,
  "subject": "Purchase Order PO-DRAFT-20260504-202834-C93A09",
  "tone": "professional"
}
```
...
```json
{
  ...
  "body_preview": "Good day Cape Tech Supplies, please find draft purchase order PO-DRAFT-20260504-202834-C93A09 for SKU-1002. Please confi",
  "dry_run": true,
...
|---|---|---|---|---|---|
| draft_supplier_reorder_message_subject | llm_micro_tool_schema | ok |  |  | {"subject": "Purchase Order PO-DRAFT-20260504-202834-C93A09"} |
| draft_supplier_reorder_message_body | llm_micro_tool_schema | ok |  |  | {"body": "Good day Cape Tech Supplies, please find draft purchase order PO-DRAFT-20260504-202834-C93A09 for SKU-1002. Please confirm availability and lead time."} |
...
### Pending Action: pa_11b9bfbd9193457588074e43845b427c
| Field | Value |
|---|---|
...
Arguments: {"body": "Good day Cape Tech Supplies, please find draft purchase order PO-DRAFT-20260504-202834-C93A09 for SKU-1002. Please confirm availability and lead time.", "draft_po": {"currency": "ZAR", "lines": [{"line_total": 4410.0, "name": "Keyboard", "quantity": 21, "sku": "SKU-1002", "unit_cost": 210.0}], "po_id": "PO-DRAFT-20260504-202834-C93A09", "status": "draft", "supplier_id": "SUP-1001", "supplier_name": "Cape Tech Supplies", "total": 4410.0}, "message": {"body": "Good day Cape Tech Supplies, please find draft purchase order PO-DRAFT-20260504-202834-C93A09 for SKU-1002. Please confirm availability and lead time.", "included_po_id": true, "included_sku_lines": true, "included_supplier_name": true, "invented_terms": false, "subject": "Purchase Order PO-DRAFT-20260504-202834-C93A09", "tone": "professional"}, "subject": "Purchase Order PO-DRAFT-20260504-202834-C93A09", "supplier": {"email": "orders@capetech.example", "lead_time_days": 5, "name": "Cape Tech Supplies", "supplier_id": "SUP-1001"}, "to": "orders@capetech.example"}
...
| Artifact | Path |
|---|---|
| TaskFrame JSON | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\taskframe.json |
| Summary JSON | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\summary.json |
| Outputs JSON | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\outputs.json |
| Audit JSON | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\audit.json |
| Run Report Markdown | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\run_report.md |
| Run Report HTML | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\run_report.html |
| Approval Pack Report Markdown | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\approval_pack_report.md |
| Approval Pack Report HTML | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\approval_pack_report.html |
| Failure Report Markdown | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\failure_report.md |
| Failure Report HTML | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\failure_report.html |
| Evidence Bundle JSON | runtime_data\outputs\runtime\runs\frame_2a1f79832984479dacc843b47813e2f3\reports\evidence_bundle.json |
## 14. Raw References

- Frame ID: frame_2a1f79832984479dacc843b47813e2f3
- Manifest ID: procurement.low_stock_reorder
- Runtime Data Dir: runtime_data\outputs\runtime
- Generated At: 2026-05-04T20:28:34Z
