...
| Field | Value |
|---|---|
| Frame ID | frame_b70387389909475d82a19a9168ae089f |
...
- Event ID: evt_5e85ffc31d4248e9aeacab27f22d6015
- Event Type: manual.accounting_payment_reconciliation
- Source: operator_scenario_pack

```json
{
  "event_id": "evt_5e85ffc31d4248e9aeacab27f22d6015",
...
```json
{
  ...
  "recon_run_id": "RECON-20260504-204751",
  "recon_run_rows": [
    [
      "RECON-20260504-204751",
      "",
...
### Pending Action: pa_872b8b8823f14a7cb0299375fbbcbc52
| Field | Value |
|---|---|
...
Arguments: {"dry_run": true, "mode": "append", "range_name": "ReconRuns!A:J", "rows": [["RECON-20260504-204751", "", 1, 1, 4, 2, 1, 1, "exceptions", ""]], "spreadsheet_id": "demo-sheet-local"}
Guardrails: ["Requires explicit approval before execution.", "UI live execution is disabled in this spec.", "Dry-run mode only."]

### Pending Action: pa_88545755ac70426c9b15150bb9617065
| Field | Value |
|---|---|
| Tool | sheet/write_rows |
| Status | EXECUTED |
...
Human Summary: This action would execute tool "sheet/write_rows" with the listed arguments.
Arguments: {"dry_run": true, "mode": "append", "range_name": "ReconExceptions!A:M", "rows": [["RECON-20260504-204751", "EXC-2E876DB7", "already_posted", "EFT-9001", "PAY-1001", "ORD-10042", "", 0.0, 0.0, "ZAR", "medium", "Payment already posted to ledger.", ""], ["RECON-20260504-204751", "EXC-CAC5D431", "amount_mismatch", "EFT-9002", "PAY-1002", "ORD-10043", "", 500.0, 450.0, "ZAR", "high", "Payment amount does not match invoice.", ""], ["RECON-20260504-204751", "EXC-EA742EF9", "duplicate_payment_ref", "EFT-9005", "PAY-1004", "ORD-10045", "", 0.0, 0.0, "ZAR", "high", "Duplicate payment reference.", ""], ["RECON-20260504-204751", "EXC-927C1774", "duplicate_payment_ref", "EFT-9005", "PAY-1005", "ORD-10046", "", 0.0, 0.0, "ZAR", "high", "Duplicate payment reference.", ""]], "spreadsheet_id": "demo-sheet-local"}
Guardrails: ["Requires explicit approval before execution.", "UI live execution is disabled in this spec.", "Dry-run mode only."]
...
| Artifact | Path |
|---|---|
| TaskFrame JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\taskframe.json |
| Summary JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\summary.json |
| Outputs JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\outputs.json |
| Audit JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\audit.json |
| Run Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\run_report.md |
| Run Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\run_report.html |
| Approval Pack Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\approval_pack_report.md |
| Approval Pack Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\approval_pack_report.html |
| Failure Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\failure_report.md |
| Failure Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\failure_report.html |
| Evidence Bundle JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_b70387389909475d82a19a9168ae089f\reports\evidence_bundle.json |
## 14. Raw References

- Frame ID: frame_b70387389909475d82a19a9168ae089f
- Manifest ID: accounting.payment_reconciliation
- Runtime Data Dir: D:\Projects\4thGenAgent\runtime_data\outputs\runtime
- Generated At: 2026-05-04T20:47:51Z
