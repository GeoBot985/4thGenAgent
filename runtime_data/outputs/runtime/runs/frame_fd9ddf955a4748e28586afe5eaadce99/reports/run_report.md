...
| Field | Value |
|---|---|
| Frame ID | frame_fd9ddf955a4748e28586afe5eaadce99 |
...
- Event ID: evt_01ef1d671f3a49eca0e91896fda04bbc
- Event Type: manual.accounting_payment_reconciliation
- Source: operator_scenario_pack

```json
{
  "event_id": "evt_01ef1d671f3a49eca0e91896fda04bbc",
...
```json
{
  ...
  "recon_run_id": "RECON-20260505-065225",
  "recon_run_rows": [
    [
      "RECON-20260505-065225",
      "",
...
### Pending Action: pa_ea8faad231d040869a189188ccb56d40
| Field | Value |
|---|---|
...
Arguments: {"dry_run": true, "mode": "append", "range_name": "ReconRuns!A:J", "rows": [["RECON-20260505-065225", "", 1, 1, 4, 2, 1, 1, "exceptions", ""]], "spreadsheet_id": "demo-sheet-local"}
Guardrails: ["Requires explicit approval before execution.", "UI live execution is disabled in this spec.", "Dry-run mode only."]

### Pending Action: pa_3808ea9639134331b29f26e5b3ede0c4
| Field | Value |
|---|---|
| Tool | sheet/write_rows |
| Status | EXECUTED |
...
Human Summary: This action would execute tool "sheet/write_rows" with the listed arguments.
Arguments: {"dry_run": true, "mode": "append", "range_name": "ReconExceptions!A:M", "rows": [["RECON-20260505-065225", "EXC-D371D8FA", "already_posted", "EFT-9001", "PAY-1001", "ORD-10042", "", 0.0, 0.0, "ZAR", "medium", "Payment already posted to ledger.", ""], ["RECON-20260505-065225", "EXC-7F768E19", "amount_mismatch", "EFT-9002", "PAY-1002", "ORD-10043", "", 500.0, 450.0, "ZAR", "high", "Payment amount does not match invoice.", ""], ["RECON-20260505-065225", "EXC-DD7FBADE", "duplicate_payment_ref", "EFT-9005", "PAY-1004", "ORD-10045", "", 0.0, 0.0, "ZAR", "high", "Duplicate payment reference.", ""], ["RECON-20260505-065225", "EXC-11959FF9", "duplicate_payment_ref", "EFT-9005", "PAY-1005", "ORD-10046", "", 0.0, 0.0, "ZAR", "high", "Duplicate payment reference.", ""]], "spreadsheet_id": "demo-sheet-local"}
Guardrails: ["Requires explicit approval before execution.", "UI live execution is disabled in this spec.", "Dry-run mode only."]
...
| Artifact | Path |
|---|---|
| TaskFrame JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\taskframe.json |
| Summary JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\summary.json |
| Outputs JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\outputs.json |
| Audit JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\audit.json |
| Run Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\run_report.md |
| Run Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\run_report.html |
| Approval Pack Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\approval_pack_report.md |
| Approval Pack Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\approval_pack_report.html |
| Failure Report Markdown | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\failure_report.md |
| Failure Report HTML | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\failure_report.html |
| Evidence Bundle JSON | D:\Projects\4thGenAgent\runtime_data\outputs\runtime\runs\frame_fd9ddf955a4748e28586afe5eaadce99\reports\evidence_bundle.json |
## 14. Raw References

- Frame ID: frame_fd9ddf955a4748e28586afe5eaadce99
- Manifest ID: accounting.payment_reconciliation
- Runtime Data Dir: D:\Projects\4thGenAgent\runtime_data\outputs\runtime
- Generated At: 2026-05-05T06:52:26Z
